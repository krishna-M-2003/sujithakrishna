      ...
      <div className="flex gap-2 sm:gap-4 mb-8">
        {[
          ...
          <button
            ...
            className={`px-4 py-2 text-xs uppercase font-semibold rounded-full tracking-wider transition-all duration-300 border ${
              activeGame === g.id
              ...
              <div className="grid grid-cols-4 gap-2.5 max-w-[240px] mx-auto mt-2">
                {Array.from({ length: 16 }).map((_, i) => (
                  <div
                    ...
                    className={`aspect-square w-12 sm:w-14 rounded-lg flex items-center justify-center cursor-pointer transition-all duration-300 font-sans text-lg border ${
                      revealedTeddyGrid[i]
